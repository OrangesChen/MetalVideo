...
- (void)viewDidLoad {
    ...
    APPLView *renderView = (APPLView *)self.view;
...
- (void)setPaused:(BOOL)pause
{
    ...
    if(_timer)
    {
        ...
        if(pause == YES)
        {
            ...
            [(APPLView *)self.view releaseTextures];
        }
        else
        {
            _gameLoopPaused = pause;
