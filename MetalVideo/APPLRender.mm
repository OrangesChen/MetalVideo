...
-(void) InitPlayer:(int)mode filePath:(NSString *)filePath{
...
//    [self InitPlayer:0 filePath:str];
    [self InitPlayer:0 filePath:@"http://live.hkstv.hk.lxdns.com/live/hks/playlist.m3u8"];
...
//                [renderEncoder setFragmentTexture:_videoTexture[_constantDataBufferIndex] atIndex:0];
